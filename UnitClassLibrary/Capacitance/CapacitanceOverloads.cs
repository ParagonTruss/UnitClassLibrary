...
namespace UnitClassLibrary
{
	...
	public partial class Capacitance : IEquatable <Capacitance>
	{
		...
		/// <returns></returns>
		public static Capacitance operator ^(Capacitance o1, double power)
		{
			return new Capacitance(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static Capacitance operator +(Capacitance o1, Capacitance o2)
		{
			return new Capacitance(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(Capacitance o1, Capacitance o2)
		{
		...
		/// <returns></returns>
		public static Capacitance operator*(Capacitance o1, double multiplier)
		{
			return new Capacitance(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static Capacitance operator*(double multiplier, Capacitance o1)
		{
		...
		/// <returns></returns>
		public static Capacitance operator/(Capacitance o1, double divisor)
		{
			return new Capacitance(o1._internalUnitType, o1._intrinsicValue / divisor);
		}

		/// <summary>Not a perfect inequality operator, is only accurate up to Constants.AcceptedEqualityDeviationConstant </summary>
		public static bool operator !=(Capacitance o1, Capacitance o2)
		{
			if ((object)o1 == null)
			{
				if ((object)o2 == null)
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals((Capacitance)obj);
		}
