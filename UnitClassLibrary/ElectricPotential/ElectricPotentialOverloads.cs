 ...
 namespace UnitClassLibrary
{
	...
	public partial class ElectricPotential : IEquatable <ElectricPotential>
	{
		...
		/// <returns></returns>
		public static ElectricPotential operator ^(ElectricPotential o1, double power)
		{
			return new ElectricPotential(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static ElectricPotential operator +(ElectricPotential o1, ElectricPotential o2)
		{
			return new ElectricPotential(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(ElectricPotential o1, ElectricPotential o2)
		{
		...
		/// <returns></returns>
		public static ElectricPotential operator*(ElectricPotential o1, double multiplier)
		{
			return new ElectricPotential(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static ElectricPotential operator*(double multiplier, ElectricPotential o1)
		{
		...
		/// <returns></returns>
		public static ElectricPotential operator/(ElectricPotential o1, double divisor)
		{
			return new ElectricPotential(o1._internalUnitType, o1._intrinsicValue / divisor);
		}

		/// <summary>Not a perfect inequality operator, is only accurate up to Constants.AcceptedEqualityDeviationConstant </summary>
		public static bool operator !=(ElectricPotential o1, ElectricPotential o2)
		{
			if ((object)o1 == null)
			{
				if ((object)o2 == null)
		...
		public override bool Equals(object obj)
		{
			...
			return this.Equals((ElectricPotential)obj);
		}
