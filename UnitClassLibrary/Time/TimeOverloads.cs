 ...
 namespace UnitClassLibrary
{
	...
	public partial class Time : IEquatable <Time>
	{
		...
		/// <returns></returns>
		public static Time operator ^(Time o1, double power)
		{
			return new Time(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static Time operator +(Time o1, Time o2)
		{
			return new Time(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(Time o1, Time o2)
		{
		...
		/// <returns></returns>
		public static Time operator*(Time o1, double multiplier)
		{
			return new Time(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static Time operator*(double multiplier, Time o1)
		{
		...
		/// <returns></returns>
		public static Time operator/(Time o1, double divisor)
		{
			return new Time(o1._internalUnitType, o1._intrinsicValue / divisor);
		}
