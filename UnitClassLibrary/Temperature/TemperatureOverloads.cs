 ...
 namespace UnitClassLibrary
{
	...
	public partial class Temperature : IEquatable <Temperature>
	{
		...
		/// <returns></returns>
		public static Temperature operator ^(Temperature o1, double power)
		{
			return new Temperature(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static Temperature operator +(Temperature o1, Temperature o2)
		{
			return new Temperature(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(Temperature o1, Temperature o2)
		{
		...
		/// <returns></returns>
		public static Temperature operator*(Temperature o1, double multiplier)
		{
			return new Temperature(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static Temperature operator*(double multiplier, Temperature o1)
		{
		...
		/// <returns></returns>
		public static Temperature operator/(Temperature o1, double divisor)
		{
			return new Temperature(o1._internalUnitType, o1._intrinsicValue / divisor);
		}

		/// <summary>Not a perfect inequality operator, is only accurate up to Constants.AcceptedEqualityDeviationConstant </summary>
		public static bool operator !=(Temperature o1, Temperature o2)
		{
			if ((object)o1 == null)
			{
				if ((object)o2 == null)
