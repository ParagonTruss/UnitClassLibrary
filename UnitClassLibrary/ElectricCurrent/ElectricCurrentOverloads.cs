...
namespace UnitClassLibrary
{
	...
	public partial class ElectricCurrent : IEquatable <ElectricCurrent>
	{
		...
		/// <returns></returns>
		public static ElectricCurrent operator ^(ElectricCurrent o1, double power)
		{
			return new ElectricCurrent(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static ElectricCurrent operator +(ElectricCurrent o1, ElectricCurrent o2)
		{
			return new ElectricCurrent(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(ElectricCurrent o1, ElectricCurrent o2)
		{
		...
		/// <returns></returns>
		public static ElectricCurrent operator*(ElectricCurrent o1, double multiplier)
		{
			return new ElectricCurrent(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static ElectricCurrent operator*(double multiplier, ElectricCurrent o1)
		{
		...
		/// <returns></returns>
		public static ElectricCurrent operator/(ElectricCurrent o1, double divisor)
		{
			return new ElectricCurrent(o1._internalUnitType, o1._intrinsicValue / divisor);
		}

		/// <summary>Not a perfect inequality operator, is only accurate up to Constants.AcceptedEqualityDeviationConstant </summary>
		public static bool operator !=(ElectricCurrent o1, ElectricCurrent o2)
		{
			if ((object)o1 == null)
			{
				if ((object)o2 == null)
