 ...
 namespace UnitClassLibrary
{
	...
	public partial class AngularDistance : IEquatable <AngularDistance>
	{
		...
		/// <returns></returns>
		public static AngularDistance operator ^(AngularDistance o1, double power)
		{
			return new AngularDistance(o1._internalUnitType, Math.Pow(o1._intrinsicValue, power));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static AngularDistance operator +(AngularDistance o1, AngularDistance o2)
		{
			return new AngularDistance(o1._internalUnitType, o1._intrinsicValue + o2.GetValue(o1._internalUnitType));
		}
		...
		/// <param name="o2"></param>
		/// <returns></returns>
		public static double operator/(AngularDistance o1, AngularDistance o2)
		{
		...
		/// <returns></returns>
		public static AngularDistance operator*(AngularDistance o1, double multiplier)
		{
			return new AngularDistance(o1._internalUnitType, o1._intrinsicValue * multiplier);
		}
		...
		/// <param name="multiplier"></param>
		/// <returns></returns>
		public static AngularDistance operator*(double multiplier, AngularDistance o1)
		{
		...
		/// <returns></returns>
		public static AngularDistance operator/(AngularDistance o1, double divisor)
		{
			return new AngularDistance(o1._internalUnitType, o1._intrinsicValue / divisor);
		}

		/// <summary>Not a perfect inequality operator, is only accurate up to Constants.AcceptedEqualityDeviationConstant </summary>
		public static bool operator !=(AngularDistance o1, AngularDistance o2)
		{
			if ((object)o1 == null)
			{
				if ((object)o2 == null)
