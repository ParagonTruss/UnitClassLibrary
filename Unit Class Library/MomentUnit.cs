...
namespace UnitClassLibrary
{
    public class MomentUnit
    {
        ...
        public MomentUnit(ForceUnit passeForce, Dimension passedDimension)
        {
            _force = passeForce;
        ...
        public static MomentUnit operator +(MomentUnit s1, MomentUnit s2)
        {
        ...
        /// </summary>
        public static bool operator ==(MomentUnit s1, MomentUnit s2)
        {
            return s1.Equals(s2);
        }
        ...
        public override bool Equals(object obj)
        {
            try
            {
                MomentUnit compare = (MomentUnit)obj;
        ...
        /// <returns></returns>
        public int CompareTo(MomentUnit other)
        {
